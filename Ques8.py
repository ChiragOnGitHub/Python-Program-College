...
def main():
    ...
    while (True):
        ...
        if choice == 1:
            ...
            if (checkNum(l)):
                print("Number of odd number in the list : ", oddValues(l))
            else:
            ...
            print("List after reversing the list is : ", reverseList(l))

        elif choice == 5:
            element = input("Enter the element to find : ")
            check = findElement(l, element)
            if (check == -1):
