...
while (True):
    ...
    if choice == 1:
        ...
        print("This string is maximum : ", maximum(string1, string2, string3))
    elif choice == 3:
        string = input("Enter the string : ")
        print("string after replacing vowel with '#' is : ", vowelReplacer(string))
    elif choice == 4:
        string = input("Enter the string : ")
        print("Number of word in the string : ", wordCounter(string))
    elif choice == 5:
        string = input("Enter the string : ")
        if string == "":
